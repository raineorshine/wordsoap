...
it('should remove class, lang, style, face, o:x, and other useless attributes', function () {
	...
	assert.equal(wordsoap('<p><i\nstyle=something>TEST</i></p>'), '<p><i>TEST</i></p>')
	assert.equal(wordsoap('<a style="mso-endnote-id:edn1" href="#_edn1" name="_ednref1">Hello</a>'), '<a href="#_edn1" name="_ednref1">Hello</a>', 'should not remove other attributes')
})
